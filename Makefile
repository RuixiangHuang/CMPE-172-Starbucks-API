...
docker-push:
	docker login
	docker build -t raidenpoi/spring-starbucks-api:latest .
	docker push raidenpoi/spring-starbucks-api:latest
	docker build -t raidenpoi/spring-starbucks-api:v3.3 .
	docker push raidenpoi/spring-starbucks-api:v3.3
